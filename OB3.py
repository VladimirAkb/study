Вот пример программы на Python, которая соответствует всем вашим требованиям. Программа включает в себя классы для животных и сотрудников, а также функции для работы с зоопарком, включая сохранение и загрузку информации из файла.
